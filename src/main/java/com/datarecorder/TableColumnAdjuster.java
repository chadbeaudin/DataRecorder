 ...
 */
public class TableColumnAdjuster extends LoggingObject implements PropertyChangeListener, TableModelListener {
     ...
     */
    protected int getColumnHeaderWidth(final int column) {
    ...
    public void tableChanged(final TableModelEvent e) {
        adjustColumns();
        // Currently commented out since the sorting seems to be causing a problem due to
        // the e.getColumn() return a -1
